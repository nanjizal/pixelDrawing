...
class Plot {
    ...
    /*public inline static function setPixelAA( pixels: Pixels, x: Int, y: Int, i: Float, col: Int, alpha: Int ) {
        i = 1 - i/alpha;
        setPixelColorAndAlpha( pixels, x, y, col, Std.int( 255*i ) );
    }*/

    public inline static function setPixelColorAndAlpha( pixels: Pixels, x: Int, y: Int, col: Int, alpha: Int ) {
    ...
    public static inline function setPixelAA(pixels:Pixels, x:Int, y:Int, i:Float, color:Int, alpha:Int = 0xFF) {
    ...
    public inline static function plotLine(     pixels:     Pixels
                                            ,   x0: Int,    y0: Int
                                            ,   x1: Int,    y1: Int
                                            ,   col: Int,   alpha: Int )
    {
    ...
    // Fully ported, untested
    public inline static function plotEllipse(  pixels:     Pixels
                                            ,   xm: Int,    ym: Int
                                            ,   a:  Int,    b:  Int
                                            ,   col: Int,   alpha: Int ){
        var x: Int = -a;
    ...
    // Fully ported, untested
    public inline static function plotOptimizedEllipse(     pixels:     Pixels
                                                        ,   xm: Int,    ym: Int
                                                        ,   a:  Int,    b:  Int
                                                        ,   col: Int,   alpha: Int ){
        var x: Float = -a;
    ...
    // Fully ported, untested
    public inline static function plotCircle( pixels:   Pixels
                                            , xm: Int,  ym: Int
                                            , r:  Float
                                            , col: Int, alpha: Int ){
        var x: Float = -r;
    ...
    public inline static function plotEllipseRect(  pixels:     Pixels
                                                ,   x0: Int,    y0: Int
                                                ,   x1: Int,    y1: Int
                                                ,   col: Int,   alpha: Int ){
    ...
    public static function plotQuadBezierSeg(    pixels:     Pixels
                                                    ,   x0: Int,    y0: Int
                                                    ,   x1: Int,    y1: Int
                                                    ,   x2: Int,    y2: Int
                                                    ,   col: Int,   alpha: Int ){
    ...
    public static function plotQuadBezier(  pixels:     Pixels
                                        ,   x0: Int,    y0: Int
                                        ,   x1: Int,    y1: Int
                                        ,   x2: Int,    y2: Int
                                        ,   col: Int,   alpha: Int ){
    ...
    public static function plotQuadRationalBezierSeg(   pixels:     Pixels
                                                    ,   x0: Int,    y0: Int
                                                    ,   x1: Int,    y1: Int
                                                    ,   x2: Int,    y2: Int
                                                    ,   w: Float
    ...
    public inline static function plotQuadRationalBezier(   pixels:     Pixels
                                                        ,   x0: Int,    y0: Int
                                                        ,   x1: Int,    y1: Int
                                                        ,   x2: Int,    y2: Int
                                                        ,   w:  Float
    ...
    public inline static function plotRotatedEllipse(   pixels:     Pixels
                                                    ,   x: Int,     y: Int
                                                    ,   a: Int,     b: Int
                                                    ,   angle:      Float
                                                    ,   col: Int,   alpha: Int ){
    ...
    public static function plotRotatedEllipseRect( pixels:    Pixels
                                                        , x0: Int,   y0: Int
                                                        , x1: Int,   y1: Int
                                                        , zd: Float
                                                        , col: Int,  alpha: Int ){
    ...
    public static function plotCubicBezierSeg( pixels:  Pixels
                                                    , x0:      Int,    y0:     Int
                                                    , x1:      Float,  y1:     Float
                                                    , x2:      Float,  y2:     Float
                                                    , x3:      Int,    y3:     Int
    ...
    public inline static function plotCubicBezier(  pixels:     Pixels
                                                ,   x0: Int,    y0: Int
                                                ,   x1: Int,    y1: Int
                                                ,   x2: Int,    y2: Int
                                                ,   x3: Int,    y3: Int
    ...
    public inline static function plotCircleAA( pixels:     Pixels
                                            ,   xm: Int,    ym: Int
                                            ,   r: Float
                                            ,   col: Int,   alpha: Int ){
        var x: Int = Std.int( -r );
    ...
    public static inline function plotEllipseRectAA( pixels:     Pixels
                                                ,   x0: Int,    y0: Int
                                                ,   x1: Int,    y1: Int
                                                ,   col: Int,   alpha: Int ){
        var a: Int = Std.int(Math.abs( x1 - x0 ));
    ...
    public static function plotQuadBezierSegAA(  pixels:     Pixels
                                                    ,   x0: Int,    y0: Int
                                                    ,   x1: Int,    y1: Int
                                                    ,   x2: Int,    y2: Int
                                                    ,   col: Int,   alpha: Int ){
    ...
    public inline static function plotQuadRationalBezierSegAA(  pixels:     Pixels
                                                            ,   x0: Int,    y0: Int
                                                            ,   x1: Int,    y1: Int
                                                            ,   x2: Int,    y2: Int
                                                            ,   w: Float
    ...
    public inline static function plotCubicBezierSegAA( pixels:     Pixels
                                                    ,   x0: Int,    y0: Int
                                                    ,   x1: Float,  y1: Float
                                                    ,   x2: Float,  y2: Float
                                                    ,   x3: Float,  y3: Float
    ...
    public inline static function plotLineWidth(    pixels: Pixels
                                                ,   x0: Int, y0: Int
                                                ,   x1: Int, y1: Int
                                                ,   wd: Float
                                                ,   col: Int, alpha: Int ){
...
//
    public inline static function plotQuadSpline( pixels: Pixels
                                                , n: Int
    ...
    public inline static function plotCubicSpline(  pixels:         Pixels
                                                ,   n: Int
                                                ,   x: Array<Int>,  y: Array<Int>
                                                ,   col: Int,       alpha: Int ) {
        var M_MAX: Int = 6;
